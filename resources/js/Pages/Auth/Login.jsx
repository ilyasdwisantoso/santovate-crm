        ...
        <>
            ...
            <main className="login-page login-page-v24">
                <section className="login-brand-panel">
                    ...
                    <div className="login-story">
                        <span className="eyebrow">
                            <Icon name="spark" size={15}/> Account Executive workspace
                        </span>
                        <h1>
                            Pipeline lebih jelas.<br/>
                            <em>Follow-up lebih disiplin.</em>
                        </h1>
                        <p>
                            CRM internal untuk membantu tim Santovate mengubah database prospek
                            menjadi percakapan, proposal, dan revenue yang terukur.
                        </p>
                ...
                <section className="login-form-panel">
                    ...
                    <form className="login-card login-card-v24" onSubmit={submit}>
                        <div className="login-card-head">
                            <span className="login-icon"><Icon name="briefcase" size={20}/></span>
                            <h2>Selamat datang kembali</h2>
                            <p>Masuk untuk melanjutkan aktivitas Account Executive Anda.</p>
                        </div>
                        ...
                        <label className="field">
                            <span>Password</span>
                            <div className={`input-icon password-input ${errors.password ? 'error' : ''}`}>
                        ...
                        <button className="btn btn-primary btn-block btn-lg" disabled={processing}>
                            {processing ? 'Memproses...' : 'Masuk ke CRM'}
