...
class Prospect extends Model
{
    ...
    protected $fillable = [
        ...
        'last_feedback_at','last_feedback_status','last_feedback_note','contacted_at','replied_at','meeting_at','demo_at',
        'proposal_at','negotiation_at','deal_at','closed_at','source_name','source_url','notes','estimated_deal_value',
        'actual_deal_value','assigned_to','created_by','import_batch_id',
    ];
    ...
    protected static function booted(): void
    {
        static::saving(function (Prospect $prospect) {
            ...
            $scoring = app(ProspectScoringService::class)->calculate((int)$prospect->fit_score,(int)$prospect->pain_score,(int)$prospect->contact_score);
    ...
    public function products(): BelongsToMany { return $this->belongsToMany(Product::class)->withPivot('is_primary')->withTimestamps(); }
